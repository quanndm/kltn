...
from .layers.layers import DoubleConv2D, OutConv2D,  ResNeXtCoT_MCB_Block2D
...
class Down(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.encoder = nn.Sequential(
            ...
            ResNeXtCoT_MCB_Block2D(in_channels, out_channels)
        )
...
class Up(nn.Module):
    def __init__(self, in_channels, out_channels, bilinear=True):
        ...
        self.conv = ResNeXtCoT_MCB_Block2D(in_channels, out_channels)
...
class MSC_CoTNeXtUNet2D(nn.Module):
