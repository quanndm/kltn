...
from .layers.layers import DoubleConv, DoubleAttention, OutConv, ConvNeXtV2CoTBlock
...
class Down(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.encoder = nn.Sequential(
            ...
            ConvNeXtV2CoTBlock(in_channels, out_channels)
        )
...
class Up(nn.Module):
    def __init__(self, in_channels, out_channels, trilinear=True):
        ...
        self.conv = ConvNeXtV2CoTBlock(in_channels, out_channels)
...
class UNet3DWConvNeXtV2CoTDA(nn.Module):
...
class UNet3DWConvNeXtV2CoTDAPretrained(nn.Module):
    def __init__(self, in_channels, n_classes, n_channels, pretrained_weights=None):
        ...
        self.unet = UNet3DWConvNeXtV2CoTDA(in_channels, n_classes, n_channels)
