...
from .layers.layers import DoubleConv, OutConv, ResNeXtCoTBlock
...
class UNet3DWResNeXtCoTPretrained(nn.Module):
    def __init__(self, in_channels, n_classes, n_channels):
        ...
        self.unet = UNet3DWResNeXtCoT(in_channels, n_classes, n_channels)
