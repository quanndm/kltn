...
from .layers.layers import DoubleConv, DoubleConvDownWCoT, DoubleConvUpWCoT, DoubleAttention, OutConv
...
class Down(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.encoder = nn.Sequential(
            ...
            DoubleConvDownWCoT(in_channels, out_channels)
        )
...
class Up(nn.Module):
    def __init__(self, in_channels, out_channels, trilinear=True):
        ...
        self.conv = DoubleConvUpWCoT(in_channels, out_channels)
...
class UNet3DWCoTDAPretrained(nn.Module):
    def __init__(self, in_channels, n_classes, n_channels, pretrained_weights=None):
        ...
        self.unet = UNet3DWCoTDA(in_channels, n_classes, n_channels)
