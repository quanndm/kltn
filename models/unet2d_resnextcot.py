...
from .layers.layers import DoubleConv2D, OutConv2D, ResNeXtCoTBlock2D
...
class Down(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.encoder = nn.Sequential(
            ...
            ResNeXtCoTBlock2D(in_channels, out_channels)
        )
...
class Up(nn.Module):
    def __init__(self, in_channels, out_channels, bilinear=True):
        ...
        self.conv = ResNeXtCoTBlock2D(in_channels, out_channels)
...
class UNet2DWResNeXtCoT(nn.Module):
